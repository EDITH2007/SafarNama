...
const cspHeader = [
  ...
  "img-src 'self' data: blob: https://translate.google.com https://translate.googleapis.com https://www.gstatic.com https://*.gstatic.com https://*.google.com https://*.googleapis.com https://*.googleusercontent.com https://images.unsplash.com https://source.unsplash.com https://*.unsplash.com https://*.tile.openstreetmap.org https://*.convex.cloud https://*.convex.site https://avatars.githubusercontent.com",
